...
// Source: github.com/ozonva/ova-account-api/internal/flusher (interfaces: Flusher)
...
func (m *MockFlusher) Flush(arg0 context.Context, arg1 []entity.Account) []entity.Account {
	m.ctrl.T.Helper()
